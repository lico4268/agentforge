...
export const STARTER_ARCHITECTURE: Architecture = {
  ...
  nodes: [
    ...
    { id: 'planning',          type: 'planning.decompose',  position: { x: 400, y: 260 }, config: {} },
    { id: 'reasoning',         type: 'reasoning.cot',       position: { x: 400, y: 520 }, config: {} },
    { id: 'review_policy',     type: 'policy.review',       position: { x: 400, y: 780 }, config: { passThreshold: 0.85, autoThreshold: 0.6 } },
    { id: 'auto_verify',       type: 'verification.auto',   position: { x: 0,   y: 1080 }, config: { maxRetries: 2 } },
